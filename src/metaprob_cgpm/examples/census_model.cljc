(ns metaprob-cgpm.examples.census-model
  (:require [metaprob-cgpm.main :refer [real-type integer-type make-cgpm]]
            [metaprob-cgpm.multimixture :as mmix :refer [multi-mixture view]]
