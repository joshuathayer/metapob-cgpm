(ns metaprob-cgpm.examples.census-search
  (:require
   [metaprob-cgpm.examples.census-model :as model]
   [metaprob-cgpm.examples.census-data :refer [data]]
